test_that("parse point line works", {
    ...
    expect_equal(
        ...
        expected_output("1|2", 1, 0L, 2)
    )

    expect_equal(
        parse_point_line("1 2 3|1 2 3"),
        expected_output("1 2 3|1 2 3", 6, 0L, 6)
    )
    ...
    expect_equal(
        ...
        expected_output("1,2|3,4", 1.2, 0L, 3.4)
    )
    ...
    expect_equal(
        ...
        expected_output("1,22|3.43", 1.22, 0L, 3.43)
    )
